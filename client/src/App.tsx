...
export function App() {
  ...
  return (
    <div className={`relative w-full h-full ${gameState?.gameType === 'uno_no_mercy' ? 'max-w-none' : 'max-w-lg md:max-w-2xl lg:max-w-4xl'} mx-auto bg-slate-950 overflow-hidden flex flex-col shadow-2xl`}>
